...
<div class="form-page-header">
    ...
    <p class="mb-0 opacity-75">The user will be attached to your school automatically.</p>
</div>

<div class="form-card">
    <form action="{{ route('principal.users.store') }}" method="POST" data-ajax-user-form>
        @csrf
