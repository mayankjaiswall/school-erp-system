...
@once
    <style>
        ...
        .account-menu-toggle{align-items:center;background:#fff;border:1px solid transparent;border-radius:6px;display:flex;gap:10px;padding:6px 8px;transition:.2s ease}
        .account-menu-toggle:hover,.account-menu.open .account-menu-toggle{background:#f8fafc;border-color:#e2e8f0;box-shadow:0 8px 20px rgba(15,23,42,.08)}
        ...
        .account-menu-dropdown{background:#fff;border:1px solid #e2e8f0;border-radius:6px;box-shadow:0 18px 45px rgba(15,23,42,.16);display:none;min-width:230px;padding:6px;position:absolute;right:0;top:calc(100% + 10px);z-index:1200}
        .account-menu.open .account-menu-dropdown{display:block}
        .account-menu-dropdown a{align-items:center;border-radius:4px;color:#334155;display:flex;gap:10px;padding:11px 12px;text-decoration:none;font-weight:600}
