...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        body{background:#f8fafc;font-family:'Segoe UI',sans-serif;font-size:15px;overflow-x:hidden}
        .sidebar{position:fixed;top:0;left:0;width:250px;height:100vh;background:linear-gradient(180deg,rgba(37,99,235,.95),rgba(15,23,42,1)),#0f172a;color:#fff;display:flex;flex-direction:column;z-index:1000;box-shadow:8px 0 30px rgba(0,0,0,.15)}
        .logo{padding:22px 22px 18px;font-size:24px;font-weight:700;border-bottom:1px solid rgba(255,255,255,.08);line-height:1}
        ...
        .sidebar-menu a.active-menu i{background:rgba(17,24,39,.12);color:#111827}.logout-wrapper{padding:18px;border-top:1px solid rgba(255,255,255,.08)}.logout-btn{width:100%;border-radius:10px;padding:10px;font-weight:600}
        .main-content{margin-left:250px;min-height:100vh}.topbar{background:#fff;padding:16px 24px;display:flex;justify-content:space-between;align-items:center;border-bottom:1px solid #e2e8f0;box-shadow:0 4px 15px rgba(0,0,0,.04)}
        .topbar h4{margin:0;font-size:22px;font-weight:700;color:#0f172a}.topbar-right{display:flex;align-items:center;gap:14px}.topbar-right i{font-size:18px;color:#475569}.topbar-right img{width:38px;height:38px;border-radius:50%;border:2px solid #dbeafe}
        .page-content{padding:24px}.content-card{background:#fff;border-radius:16px;padding:22px;margin-top:22px;box-shadow:0 8px 24px rgba(15,23,42,.07);border:1px solid #e5e7eb}
        .stats-card{color:#fff;padding:20px 22px;border-radius:16px;position:relative;overflow:hidden;min-height:126px;box-shadow:0 8px 22px rgba(0,0,0,.07)}.stats-card h2{font-size:28px;margin:9px 0;font-weight:700;line-height:1}.stats-card h6{font-size:15px;font-weight:600;margin-bottom:0}.stats-card small{font-size:13px}.stats-card::after{content:'';position:absolute;width:92px;height:92px;background:rgba(255,255,255,.15);border-radius:50%;top:-20px;right:-20px}
