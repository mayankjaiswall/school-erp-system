...
<div class="school-list-header">
    ...
    <div>
        ...
        <p class="mb-0 opacity-75">
            Manage all registered schools from one dashboard.
        </p>
    </div>
...
<div class="table-card">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        ...
        <form action="{{ route('schools.index') }}" method="GET" class="d-flex gap-2" role="search">
            <input type="search"
                   name="search"
                   value="{{ $search ?? '' }}"
                   class="form-control"
            ...
            @if(!empty($search))
                <a href="{{ route('schools.index') }}" class="btn btn-light border">Clear</a>
            @endif
        </form>

        <div class="text-muted">
            {{ $schools->count() }} Records Found
        </div>
